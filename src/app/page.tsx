    ...
    <Container>
      <div className="flex flex-col gap-10 mt-5 items-center justify-center sm:flex-row">
        <Link
          ...
          href="/consultglargina"
        >
          Glargina
          <BiSolidCapsule size={48} />
        </Link>
        <Link
          className="text-3xl bg-[var(--accent-orange)] flex flex-col gap-1 items-center p-5 text-white rounded-2xl cursor-pointer hover:bg-[var(--accent-orange-hover)] duration-300"
          href="/consultflexpen"
        >
          FlexPen
